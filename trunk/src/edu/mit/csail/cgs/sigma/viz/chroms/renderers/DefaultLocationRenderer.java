...
public class DefaultLocationRenderer implements ChromInformationRenderer<ChromLocations> {
	
	private Color color;
	
	public DefaultLocationRenderer(Color c) { 
		color = c;
	}
	...
	public void paintInformation(ChromLocations info, Graphics2D g2, int x1, int y1, int x2, int y2) {
		...
		int[] yshape = new int[] { 0, twidth, twidth };
